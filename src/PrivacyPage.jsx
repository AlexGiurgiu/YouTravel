    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="fixed top-0 left-0 w-full z-50 bg-white border-b border-neutral-200">
        <div className="max-w-6xl mx-auto flex items-center justify-between py-2 px-4">
          {/* Logo → către home în aceeași limbă */}
          <Link to={isEN ? "/en" : "/"} className="flex items-center" aria-label="YouTravel">
            <img
              src="/images/logo-youtravel-white.webp"
              alt="YouTravel"
              className="h-12"
            />
          </Link>
          {/* Back link → către home în aceeași limbă */}
